        ...
        {isSearched && (searchFilter.title || searchFilter.location) && (
          <>
            ...
            <div className="mb-4 text-gray-600 flex flex-wrap gap-2">
              {searchFilter.title && (
                <span className="inline-flex items-center gap-2.5 bg-blue-50 border border-gray-200 px-4 py-1.5 rounded">
                  {searchFilter.title}
                  <img
                    onClick={() =>
              ...
              {searchFilter.location && (
                <span className="inline-flex items-center gap-2.5 bg-red-50 border border-gray-200 px-4 py-1.5 rounded">
                  {searchFilter.location}
                  <img
                    onClick={() =>
